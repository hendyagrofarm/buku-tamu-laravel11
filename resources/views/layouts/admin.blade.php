...
<head>
    ...
    <title>
        @yield('title', 'Admin') - Buku Tamu Digital
    </title>
</head>
...
<div class="min-h-screen lg:flex">
    ...
    <aside class="hidden w-64 shrink-0 bg-slate-900 text-white lg:block">
        ...
        <div class="border-b border-white/10 px-6 py-6">
            ...
            <p class="text-xs uppercase tracking-[.25em] text-emerald-300">
                Buku Tamu Digital
            </p>
        ...
        <nav class="space-y-1 p-4 text-sm">
            ...
            <a
                ...
                target="_blank"
                class="block rounded-xl px-4 py-3 text-slate-300 hover:bg-white/10"
            >
                Buka Mode Tablet
            </a>
    ...
    <div class="min-w-0 flex-1">
        ...
        <header class="sticky top-0 z-30 border-b border-slate-200 bg-white/95 px-4 py-4 backdrop-blur sm:px-6">
            ...
            <div class="mt-3 flex gap-2 overflow-x-auto lg:hidden">
                ...
                <a
                    href="{{ route('admin.dashboard') }}"
                    class="whitespace-nowrap rounded-full px-3 py-2 text-xs font-semibold
                    {{
                        request()->routeIs('admin.dashboard')
